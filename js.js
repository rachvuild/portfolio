...
projet.addEventListener("mouseenter", function( event ) {
applique.innerHTML =  '<html>
...
<section class="ima">
  <a class="im" href="formulaire/formulaire_client.html"><img class="im" src="../img/client.webp"> </a>
  <a class="im" href="formulaire/formulaire_chat.html"><img class="im" src="../img/chat.png"></a>
  <a class="im" href="formulaire/formulaire_refuge.html"><img class="im" src="../img/refuge.webp"></a>
</section>
<section class="footer">
  <div>
    <ul>
      ...
      <li><a href="formulaire/formulaire_chat.html">chat</a></li>
      <li ><a href="formulaire/formulaire_refuge.html">refuge</a></li>
  </ul>
  </div>
  ...
  <div>
   ...
   <a href="formulaire/formulaire_client.html"> <img class="logo" src="../img/person-add-outline.svg" alt=""></span></a> 
